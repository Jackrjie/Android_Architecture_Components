...
import com.tim.moviedatabase.BR;
...
public class Movie extends BaseObservable implements Parcelable
{
    ...
    private String posterPath; // we need to use Glide to insert photo
    ...
    public static final DiffUtil.ItemCallback<Movie> CALLBACK = new DiffUtil.ItemCallback<Movie>() {
        ...
        public boolean areItemsTheSame(@NonNull Movie oldItem, @NonNull Movie newItem) {
            // if true, DiffUtil will check their content for confirmation
